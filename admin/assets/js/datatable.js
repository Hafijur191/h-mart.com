          ...
          exports.DataTable = class {
            ...
            renderPage(t = !1) {
              ...
              if (
                ...
                this.options.rowNavigation &&
                  (!this.rows.cursor ||
                    !this.pages[this.currentPage - 1].includes(
                      this.rows.cursor
                    )))
              ) {
                  ...
                  (t) => {
                    ...
                    e &&
                      ...
                      (e.hasAttribute("data-page")
                        ? (this.page(e.getAttribute("data-page")),
                          t.preventDefault())
                        : this.options.sortable &&
                          e.classList.contains("dataTable-sorter") &&
                          "false" !=
                            e.parentNode.getAttribute("data-sortable") &&
                          (this.columns.sort(
                            this.headings.indexOf(e.parentNode)
                          ),
                          t.preventDefault()));
                  },
                  !1
                      ...
                      38 === t.keyCode
                        ? this.rows.cursor.previousElementSibling
                          ? (this.rows.setCursor(
                            ...
                            t.stopPropagation())
                          : this.onFirstPage ||
                            this.page(this.currentPage - 1, !0)
                        : 40 === t.keyCode
                  ...
                  t.forEach((t, e) => {
                    ...
                    this.data.forEach((t) => {
                      Array.from(t.cells).forEach((t, e) => {
                        this.columns.visible(t.cellIndex) &&
                          (t.style.width = `${a[e]}%`);
                      });
                    }),
