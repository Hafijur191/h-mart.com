...
if(isset($_POST['add_category'])){
    ...
    if(!empty($file_name)){
        if(in_array($extn,$extensions) === true){
            ...
            $cat_insert = "INSERT INTO mart_category (c_name,c_image,c_parent,c_status) VALUES ('$name','$update_name','$c_parent','1')";
        ...
        $cat_insert = "INSERT INTO mart_category (c_name,c_parent,c_status) VALUES ('$name','$c_parent','1')";
            $cat_insert_res = mysqli_query($db, $cat_insert);
            if($cat_insert_res){
                header('location: ../category.php');
            }else{
